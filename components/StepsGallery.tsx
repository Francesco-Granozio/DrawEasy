...
export const StepsGallery: React.FC<StepsGalleryProps> = ({ steps, onReset }) => {
  return (
    <div className="w-full flex flex-col items-center">
      ...
      <button
        onClick={onReset}
        className="mt-12 px-8 py-3 bg-amber-600 text-white font-semibold rounded-lg shadow-md hover:bg-amber-700 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:ring-opacity-75 transition-transform transform hover:scale-105"
      >
        Start a New Drawing
      </button>
    </div>
